...
const LockUnlock = () => {
  ...
  return (
    <button
      ...
      className="bg-white rounded-full p-1.5 text-gray-800 hover:bg-gray-100 hover:text-black focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500 mr-3 sm:mr-1"
    >
      {locked ? (

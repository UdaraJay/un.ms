...
const tos = () => (
  <PageLayout>
    ...
    <p className="mb-3">
      ...
      <a href="https://un.ms">https://un.ms</a> and any related services
      provided by un.ms.{' '}
    </p>
    <p className="mb-3">
      By accessing <a href="https://un.ms">https://un.ms</a>, you agree to abide
      by these Terms of Service and to comply with all applicable laws and
      ...
      services provided by un.ms.{' '}
    </p>
    <p className="mb-3">
      We, un.ms, reserve the right to review and amend any of these Terms of
    ...
    <p className="mb-3">
      These Terms of Service were last updated on 7 August 2021.{' '}
    </p>
    <h3 className="mb-2 mt-10 font-medium">Limitations of Use</h3>
    <p className="mb-3">
      By using this website, you warrant on behalf of yourself, your users, and
      other parties you represent that you will not:{' '}
    </p>
    <ol className="list-inside  list-disc mb-2">
      <li>
    ...
    <h3 className="mb-2 mt-10 font-medium">Intellectual Property</h3>
    <p className="mb-3">
      The intellectual property in the materials contained in this website are
      owned by or licensed to un.ms and are protected by applicable copyright
    ...
    <p className="mb-3">
      ...
      restrictions or the Terms of Service, and may be terminated by un.ms at
      any time.{' '}
    </p>
    <h3 className="mb-2 mt-10 font-medium">User-Generated Content</h3>
    <p className="mb-3">
    ...
    <h3 className="mb-2 mt-10 font-medium">Liability</h3>
    <p className="mb-3">
      Our website and the materials on our website are provided on an 'as is'
      basis. To the extent permitted by law, un.ms makes no warranties,
    ...
    <p className="mb-3">
      In no event shall un.ms or its suppliers be liable for any consequential
      ...
      un.ms or an authorized representative has been notified, orally or in
    ...
    <h3 className="mb-2 mt-10 font-medium">Accuracy of Materials</h3>
    <p className="mb-3">
      The materials appearing on our website are not comprehensive and are for
      general information purposes only. un.ms does not warrant or make any
    ...
    <h3 className="mb-2 mt-10 font-medium">Links</h3>
    <p className="mb-3">
      un.ms has not reviewed all of the sites linked to its website and is not
      responsible for the contents of any such linked site. The inclusion of any
      link does not imply endorsement, approval, or control by un.ms of the
    ...
    <h3 className="mb-2 mt-10 font-medium">Right to Terminate</h3>
    <p className="mb-3">
    ...
    <h3 className="mb-2 mt-10 font-medium">Severance</h3>
    <p className="mb-3">
    ...
    <h3 className="mb-2 mt-10 font-medium">Governing Law</h3>
    <p className="mb-3">

...
const PrivacyPolicy = () => (
  <PageLayout>
    ...
    <p className="mb-3">
      Your privacy is important to us. It is un.ms&#39; policy to respect your
      ...
      website, <a href="https://un.ms">https://un.ms</a>, and other sites we own
      and operate.{' '}
    </p>
    <p className="mb-3">
    ...
    <p className="mb-3">This policy is effective as of 7 August 2021. </p>
    <p className="mb-3">Last updated: 7 August 2021 </p>
    <h3 className="mb-2 mt-10 font-medium">Information We Collect</h3>
    <p className="mb-3">
    ...
    <p className="mb-3">
      ...
      information automatically sent by your devices in the course of accessing
    ...
    <h3 className="mb-2 mt-10 font-medium">Children’s Privacy</h3>
    <p className="mb-3">
    ...
    <h3 className="mb-2 mt-10 font-medium">
    ...
    <ul>
      ...
      <li>
        ...
        providers, data storage, hosting and server providers, error loggers,
        debt collectors, maintenance or problem-solving providers, professional
    ...
    <p className="mb-3">Third parties we currently use include: </p>
    <ul>
      <li>Stripe</li>
    </ul>
    <h3 className="mb-2 mt-10 font-medium">
    ...
    <h3 className="mb-2 mt-10 font-medium">Use of Cookies</h3>
    <p className="mb-3">
    ...
    <h3 className="mb-2 mt-10 font-medium">Business Transfers</h3>
    <p className="mb-3">
    ...
    <h3 className="mb-2 mt-10 font-medium">Limits of Our Policy</h3>
    <p className="mb-3">
    ...
    <h3 className="mb-2 mt-10 font-medium">Changes to This Policy</h3>
    <p className="mb-3">
    ...
    <p className="mb-3">
      ...
      controllers&rdquo;) and organizations that process personal information on
      behalf of other organizations (known as &ldquo;data processors&rdquo;).
      We, un.ms, located at the address provided in our Contact Us section, are
    ...
    <p className="mb-3">
      ...
      your email address for the purpose of receiving marketing emails from us.
      While you may unsubscribe at any time, we cannot recall any email we have
    ...
    <p className="mb-3">
      ...
      information&rdquo; in the subject line. You may make this type of request
    ...
    <p className="mb-3">
      ...
      this time, we do not respond to browser &ldquo;Do Not Track&rdquo;
      signals.{' '}
    </p>
    <p className="mb-3">
    ...
    <p className="mb-3">
      ...
      the business purposes described in the &ldquo;Collection and Use of
    ...
    <h3 className="mb-2 mt-10 font-medium">Contact Us</h3>
    <p className="mb-3">

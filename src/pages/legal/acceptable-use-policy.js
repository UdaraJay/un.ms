...
const AcceptableUsePolicy = () => (
  <PageLayout>
    <h2 className="text-xl font-semibold mb-6"> Acceptable Use Policy</h2>
    <p className="mb-3">
      This acceptable use policy covers the products, services, and technologies
      (collectively referred to as the &ldquo;Products&rdquo;) provided by un.ms
      under any ongoing agreement. It’s designed to protect us, our customers,
      and the general Internet community from unethical, irresponsible, and
      illegal activity.{' '}
    </p>
    <p className="mb-3">
      un.ms customers found engaging in activities prohibited by this acceptable
      use policy can be liable for service suspension and account termination.
      In extreme cases, we may be legally obliged to report such customers to
      the relevant authorities.{' '}
    </p>
    <p className="mb-3">This policy was last reviewed on 7 August 2021. </p>
    <h3 className="mb-2 mt-10 font-medium">Fair use</h3>
    <p className="mb-3">
      We provide our facilities with the assumption your use will be
      &ldquo;business as usual&rdquo;, as per our offer schedule. If your use is
    ...
    <p className="mb-3">
      ...
      (&ldquo;end-users&rdquo;) to likewise engage our Products with similar
      intent.{' '}
    </p>
    <h3 className="mb-2 mt-10 font-medium">Customer accountability</h3>
    <p className="mb-3">
    ...
    <h3 className="mb-2 mt-10 font-medium">Prohibited activity</h3>
    ...
    <p className="mb-3">
      ...
      or telephone numbers subscribed in this way. All messaging lists run on or
      hosted by our Products must be &ldquo;confirmed opt-in&rdquo;.
      Verification of the address or telephone number owner’s express permission
    ...
    <p className="mb-3">
      ...
      not authorized to access the resource (e.g. &ldquo;hacking&rdquo;,
      &ldquo;cracking&rdquo;, &ldquo;phreaking&rdquo;, etc.).{' '}
    </p>
    <p className="mb-3">
    ...
    <h4>Unauthorized use of un.ms property</h4>
    <p className="mb-3">
      We prohibit the impersonation of un.ms, the representation of a
      significant business relationship with un.ms, or ownership of any un.ms
      property (including our Products and brand) for the purpose of
      fraudulently gaining service, custom, patronage, or user trust.{' '}
    </p>
    <h3 className="mb-2 mt-10 font-medium">About this policy</h3>
    <p className="mb-3">

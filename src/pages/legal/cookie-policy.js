...
const CookiePolicy = () => (
  <PageLayout>
    ...
    <p className="mb-3">
      ...
      <a href="https://un.ms">https://un.ms</a>. This cookie policy is part of
      un.ms&#39; privacy policy. It covers the use of cookies between your
      device and our site.{' '}
    </p>
    <p className="mb-3">
      We also provide basic information on third-party services we may use, who
      may also use cookies as part of their service. This policy does not cover
      their cookies.{' '}
    </p>
    <p className="mb-3">
      If you don’t wish to accept cookies from us, you should instruct your
      browser to refuse cookies from <a href="https://un.ms">https://un.ms</a>.
      In such a case, we may be unable to provide you with some of your desired
      content and services.{' '}
    </p>
    <h3 className="mb-2 mt-10 font-medium">What is a cookie?</h3>
    <p className="mb-3">
      ...
      browser when you return, additional data that serves the cookie’s purpose,
      and the lifespan of the cookie itself.{' '}
    </p>
    <p className="mb-3">
      Cookies are used to enable certain features (e.g. logging in), track site
      usage (e.g. analytics), store your user settings (e.g. time zone,
    ...
    <p className="mb-3">
      ...
      tracked across all site users. They help companies understand visitor
      ...
      website you’re visiting (first-party) or by third-party services. They do
      not collect personal information about you.{' '}
    </p>
    <p className="mb-3">We do not use this type of cookie on our site. </p>
    ...
    <p className="mb-3">
      ...
      provide you with customized, enhanced, or optimized content and services.
      These cookies may be set by the website you’re visiting (first-party) or
    ...
    <p className="mb-3">
      ...
      most relevant and appropriate to you and your interests. Websites may use
      them to deliver targeted advertising or limit the number of times you see
      an advertisement. This helps companies improve the effectiveness of their
      campaigns and the quality of content presented to you. These cookies may
      be set by the website you’re visiting (first-party) or by third-party
      services. Targeting/advertising cookies set by third-parties may be used
